...
export function LandingScreen() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center min-h-screen bg-fill-1">
      <div className="flex flex-col items-center gap-8 max-w-md w-full px-6">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-ui-md text-text-2 text-center">
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 h-10 rounded-lg border border-stroke-1 text-text-2 text-ui-md transition-colors hover:bg-alt-1"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 h-10 rounded-lg bg-accent-primary text-text-on-brand text-ui-md font-medium transition-colors hover:bg-accent-primary-hover disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Create
              </button>
            </div>
