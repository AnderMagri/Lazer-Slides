    ...
    <div className="flex-1 flex items-center justify-center min-h-screen bg-fill-1 relative">
      ...
      <div className="flex flex-col items-center gap-8 max-w-md w-full px-6">
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="w-12 h-12 rounded-sm" style={{ background: "var(--lazer-gradient)" }} />
        ...
        {!showNewForm ? (
          <div className="flex flex-col gap-3 w-full">
            <button
              ...
              className="flex items-center justify-center gap-2 w-full h-12 rounded-sm bg-accent-primary text-text-on-brand text-ui-lg font-medium transition-colors hover:bg-accent-primary-hover"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full h-12 rounded-sm border border-accent-primary text-accent-primary text-ui-lg font-medium transition-colors hover:bg-accent-primary hover:text-text-on-brand"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full h-12 rounded-sm border border-stroke-1 text-text-2 text-ui-lg transition-colors hover:bg-alt-1 hover:text-text-1"
            >
              <FolderOpen size={20} />
              Open Existing
            </button>
          ...
          <div className="flex flex-col gap-3 w-full">
            <input
              ...
              className="w-full h-12 px-4 rounded-sm bg-fill-2 border border-stroke-1 text-text-1 text-ui-lg placeholder:text-text-3 outline-none focus:border-accent-primary transition-colors"
            />
            <div className="flex gap-2">
              <button onClick={() => setShowNewForm(false)} className="flex-1 h-10 rounded-sm border border-stroke-1 text-text-2 text-ui-md transition-colors hover:bg-alt-1">Cancel</button>
              <button onClick={handleCreate} disabled={!projectName.trim()} className="flex-1 h-10 rounded-sm bg-accent-primary text-text-on-brand text-ui-md font-medium transition-colors hover:bg-accent-primary-hover disabled:opacity-40 disabled:cursor-not-allowed">Create</button>
            </div>
          </div>
        )}
      </div>
